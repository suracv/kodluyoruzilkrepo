  ...
  let html = `
    <div class="menu-items col-lg-6 col-sm-12">
      ...
      <div class="menu-info">
        ...
        <div class="menu-text">${product.desc}</div>
      </div>
    </div>  
  `;
  return html;
